...
1)Смотрим текущие значения переменных
...
2)Файл конфигурации MySQL bash-4.4# cat my.cnf
      ...
      # Default value - 1.  
      # Ставим Значение  0 - Не сбрасывать буфер  UPDATE-транзакций на диск. 
      innodb_flush_log_at_trx_commit=0

      # При установке в 0 вышеуказанного параметра, данный параметр не имеет смысла.
      innodb_flush_method = O_DSYNC

      # Компрессия применяется только к вновь создаваемым таблицам .
