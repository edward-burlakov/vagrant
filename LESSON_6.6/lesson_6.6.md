...
---
### Задача 3
Перед выполнением задания познакомьтесь с документацией по !(https://dev.mysql.com/doc/refman/8.0/en/common-errors.html "Common Mysql error")
...
---
### Задача 4
Перед выполнением задания ознакомьтесь со статьей !(https://www.percona.com/blog/2020/06/05/10-common-postgresql-errors  "Common PostgreSQL errors")
