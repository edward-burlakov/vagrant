...
9)        и на это время блокирует запись новых пар ключей в СУБД) 
          ...
          Рекомендую развернуть и использовать сиcтему мониторинга и управления дотсупностью кластера Redis Sentinel .
