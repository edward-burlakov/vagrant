...
9)         проверив обязательноt наличие параметра TTL в операции добавления ключей в БД Redis .
           А также исключил  ситуацию, когда в БД Redis записываются ключи  со срок TTL, устанвленым на одну дату,
