...
8) Исправление ситуации:
   ...
   Предполагаемые  причины две:
       ...
       1) Работа кластера нарушена ( например, мастер-нода пытается и не может сохранить изменённые ключии на удаленные реплики и на это время блокирует  новые запасиси в БД) 
