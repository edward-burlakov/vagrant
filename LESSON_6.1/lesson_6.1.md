...
----
    ...
    2) При сетевых сбоях, система может разделиться на 2 раздельных кластера:       -   AP, PA-EL ( PT-есть, А -не гарантирована в моменте, C-согласованность не  гарантирована)  
    
   3) Система может не прислать корректный ответ или сбросить соединение:          -    CP, PC-EL (  PT-есть, C-согласованность  есть, А- не гарантирована в моменте) 
