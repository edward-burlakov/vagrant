...
----
    ...
    При сетевых сбоях, система может разделиться на 2 раздельных кластера:       -    CP, PA-EC ( A-доступность не гарантирована , C-целостность и PT-есть ) 
    Система может не прислать корректный ответ или сбросить соединение:          -    CP, PA-EC  ( A-доступность не гарантирована )  
