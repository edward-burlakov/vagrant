...
Сценарий_3 
    ...
    XEN
        ...
        - Влияние работы высокостаьильного гипеивзора исключается из факторов, влиящих на устойчивость тестовых виртуалок
...
- При постановке от бизнеса задачи отказа от одной из компонентов гетерогенной среды(с решениями от разных вендоров) 
  ...
  Это чревато возникновением целого ряда проблем:
   ...
   - Возможное полное отсутствие приложений конвертации исполняемого образа гостевой виртуальной машины в образ, независимый от аппаратного обеспечения.
   - Отсутствие поддержки виртуальных драйверов, предлагаемых новым гипервизором, для ОС системой переносимой гостевой виртуалки.
   - Критичное снижение скорости работы приложений дисковых подсистемы,  
     в силу отсутствия предварительного тестирования работы сервисов на гипервизоре другого типа 
     и необходимость переписывать ПО гостевой виртуальной машины. 
     и т.д.
